...
class MedicalMeasDoc extends StatefulWidget {
  const MedicalMeasDoc({Key? key}) : super(key: key);

  @override
  State<MedicalMeasDoc> createState() => _MedicalMeasDocState();
}

class _MedicalMeasDocState extends State<MedicalMeasDoc> {
    ...
    return Scaffold(
        appBar: AppBar(
          ...
          title: Padding(
            ...
            child: Text("Medical measurement",style: TextStyle(
