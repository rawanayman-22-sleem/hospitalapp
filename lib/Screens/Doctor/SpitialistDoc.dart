...
import 'package:hospitalapp/Screens/Doctor/AttendDoc.dart';
import '../../Const/color.dart';
import '../Notification/Notification.dart';
import '../Profil/ProfileScreen.dart';
import '../ReportScreen/ReportSccreen.dart';
import 'CallScDoc.dart';
import 'CaseScreen.dart';
import 'TaskDoc.dart';


class SpitialistDoc extends StatelessWidget {
  const SpitialistDoc({Key? key}) : super(key: key);
            ...
            children: [
              Column(
                ...
                children: [
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(
                          builder: (context) => CallsScreenDoc()),);
                    },
                    child: Padding(
              ...
              Column(
                ...
                children: [
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => TaskDoc()),);
