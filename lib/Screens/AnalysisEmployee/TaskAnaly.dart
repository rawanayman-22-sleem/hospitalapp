...
import 'package:hospitalapp/Screens/AnalysisEmployee/TaskDetails1.dart';

import '../../Constant/color.dart';

class TaskAnaly extends StatefulWidget {
  const TaskAnaly({super.key});

  @override
  State<TaskAnaly> createState() => _TaskAnalyState();
}

class _TaskAnalyState extends State<TaskAnaly> {
        ...
        children: [
          Row(
            children: [
              ...
              InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> TaskDetails1 ()));
                  },
