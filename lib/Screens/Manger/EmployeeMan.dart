...
class EmployeeMan extends StatefulWidget {
  const EmployeeMan({super.key});

  @override
  State<EmployeeMan> createState() => _EmployeeManState();
}

class _EmployeeManState extends State<EmployeeMan> {
  var x = "All";
  @override
