...
import 'CaseDetailsMan.dart';
import 'SpitialistManeger.dart';


class CaseMan extends StatelessWidget {
  const CaseMan({Key? key}) : super(key: key);
                                ...
                                child: ElevatedButton(
                                  ...
                                  onPressed: () {
                                     Navigator.push(context, MaterialPageRoute(
                                         builder: (context) => CaseDetailsMan()),);
                                  },
                                  child: Row(
