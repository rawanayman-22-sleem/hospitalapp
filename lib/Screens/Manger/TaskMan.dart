...
import 'TaskDetails4.dart';


class TasksMan extends StatefulWidget {
  const TasksMan({super.key});

  @override
  State<TasksMan> createState() => _TasksManState();
}

class _TasksManState extends State<TasksMan> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context) => SpitialistManeger()),);
            },
        ...
        children: [
          Row(
            children: [
              ...
              InkWell(
                  onTap: (){
                     Navigator.push(context, MaterialPageRoute(builder: (context)=> TaskDetails4 ()));
                  },
