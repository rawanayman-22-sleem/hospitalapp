...
class TasksHR extends StatefulWidget {
  const TasksHR({super.key});

  @override
  State<TasksHR> createState() => _TasksHRState();
}

class _TasksHRState extends State<TasksHR> {
                                ...
                                Padding(
                                  ...
                                  child:Container(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {
                                        Navigator.push(context, MaterialPageRoute(builder: (context)=>TaskDetails3()));
                                      },
                                      child: Row(
