...
class CreatReportManger extends StatefulWidget {
  const CreatReportManger({super.key});

  @override
  State<CreatReportManger> createState() => _CreatReportMangerState();
}

class _CreatReportMangerState extends State<CreatReportManger> {
  bool _isHidden = true;
  @override
