        ...
        children: [
          Row(
            children: [
              ...
              InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> CreatReport ()));
                  },
                                ...
                                Padding(
                                  ...
                                  child:Container(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      onPressed: () {Navigator.push(context, MaterialPageRoute(builder: (context)=>ReportDetScreen()));
                                      },
                                      child: Row(
                                        mainAxisSize: MainAxisSize.min,
                                        children: [
