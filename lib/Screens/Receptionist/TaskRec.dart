...
class TasksRecep extends StatefulWidget {
  const TasksRecep({super.key});

  @override
  State<TasksRecep> createState() => _TasksRecepState();
}

class _TasksRecepState extends State<TasksRecep> {
        ...
        children: [
          Row(
            children: [
              ...
              InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> TaskDetails6 ()));
                  },
