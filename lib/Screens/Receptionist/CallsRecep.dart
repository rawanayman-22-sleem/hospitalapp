...
import 'package:hospitalapp/Screens/Receptionist/CreateCall.dart';
import '../../Const/color.dart';
import 'SpitialistRecep.dart';

class CallRecep extends StatefulWidget {
  const CallRecep({super.key});

  @override
  State<CallRecep> createState() => _CallRecepState();
}

class _CallRecepState extends State<CallRecep> {
      ...
      appBar: AppBar(
        ...
        leading: InkWell(
            onTap: (){
               ...
               Navigator.push(context, MaterialPageRoute(builder: (context) => SpitialistRecep()),);
            },
        ...
        children: [
          Row(
            children: [
              ...
              InkWell(
                  onTap: (){
                    Navigator.push(context, MaterialPageRoute(builder: (context)=> CreateCallRecep ()));
                  },
              ...
              children: [
                InkWell(
                  ...
                  //  Navigator.push(context, MaterialPageRoute(
                      //  builder: (context) => ReportDetScreen()),);
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      //child: Image.asset("asset/image/Group 4701.png"),
                                    ),
                                    Padding(
                                  ...
                                  child:Container(
                                    ...
                                    child: ElevatedButton(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                        // Image.asset('asset/image/Group 4701.png')
