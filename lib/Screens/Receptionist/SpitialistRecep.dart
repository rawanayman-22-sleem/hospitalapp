...
import 'AttendRec.dart';
import 'CallsRecep.dart';

class SpitialistRecep extends StatelessWidget {
  const SpitialistRecep({Key? key}) : super(key: key);
      ...
      appBar: AppBar(
        ...
        title: Column(
          children: [
            ...
            Text(
              "Specialist , Receptions",style: TextStyle(
              fontSize: 10,
              color: lightgreen,
            ),
            ),
            ...
            children: [
              ...
              Column(
                ...
                children: [
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(builder: (context) => TasksRecep()),);
                  ...
                  InkWell(
                    onTap: (){
                      Navigator.push(context, MaterialPageRoute(
                          builder: (context) => AttendScreenRecep()),);
                    },
                    child: Padding(
